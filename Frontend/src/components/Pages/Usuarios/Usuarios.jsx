...
const Usuarios = () => {
	...
	const columns = [
		...
		{ field: 'cod_alumno', headerName: 'Código', width: 220 },
		{ field: 'estado_prestamo', headerName: 'Estado Préstamo', width: 220 },
		{
			field: '',
			headerName: 'Acciones',
			width: 200,
	...
	return (
		<>
			...
			<Page title="TrackerTecsup | Usuarios">
